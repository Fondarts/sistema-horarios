...
export function ConfigurationModal({ isOpen, onClose, isEmployeeDashboard = false, asPage = false }: ConfigurationModalProps) {
  ...
  // Si se renderiza como página, solo mostrar el contenido
  if (asPage) {
    return (
